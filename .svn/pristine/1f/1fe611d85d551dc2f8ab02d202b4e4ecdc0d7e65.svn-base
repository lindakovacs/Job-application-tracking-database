...
/* **** The reports table. **** */
$reports_query = "INSERT INTO ".REPORTS_TABLE." (report_number, report_name, select_statement, select_parameter1, select_parameter2, select_parameter3, displayorder) VALUE ('$_POST[reportnumber]', '$newreportname', '$_POST[select]', '$_POST[parameter1]', '$_POST[parameter2]', '$_POST[parameter3]', '$nextdisplayorder')";
...
foreach($_POST['header'] as $value){
	$headers_query = "INSERT INTO ".REPORT_HEADER_TABLE." (report_number, header_name, header_order, comment) VALUE('$_POST[reportnumber]', '$value', '$display_order', '$newreportname')";

...
Description: Perfomans a number of functions.  The primary funcrtion is to draw a 'sparkline'-like graph at the top of the page, showing the number of job applications per week over the previous 5 weeks.

...
/* $header_rows = $result->fetch_assoc(); */
...
<td><input type='text' name='parameter1' value='$select_parameter1' size=20></td>
<td><input type='text' name='parameter2' value='$select_parameter2' size=20></td>
<td><input type='text' name='parameter3' value='$select_parameter3' size=20></td>
</tr>
</tbody>
</table>
</fieldset>
...
while($row = $result_cells->fetch_assoc()){
	...
	echo "<td><input type='text' name='cell[]' value='$row[cell_format]' size='$length'></td>";
}
